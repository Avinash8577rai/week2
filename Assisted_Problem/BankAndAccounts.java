...
public class BankAndAccounts{
    public static void main(String[] args) {
        ...
        Account account1 = new Account("755123456", 1000.0);
        Account account2 = new Account("755654321", 2000.0);
        Account account3 = new Account("755112233", 1500.0);
        ...
        // View accounts of all customers
