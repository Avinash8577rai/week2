...
public class CompanyAndDepartments {
    public static void main(String[] args) {
        ...
        dept1.addEmployee(new Employee("Vishal", "Research Scientist"));
        dept1.addEmployee(new Employee("SatyaPrakash", "Data Analyst"));

        dept2.addEmployee(new Employee("Anand", "HR Manager"));
        dept2.addEmployee(new Employee("Ankit
		", "Recruiter"));
