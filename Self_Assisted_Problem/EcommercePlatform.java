...
public class EcommercePlatform {
    public static void main(String[] args) {
        ...
        Customer customer1 = new Customer("Avinash");
        Customer customer2 = new Customer("Binod");

        // Creating products
        Product product1 = new Product("Laptop", 45000.00);
        Product product2 = new Product("Phone", 25999.00);
        Product product3 = new Product("Headphones", 999.00);
        Product product4 = new Product("Keyboard", 499.00);

        // Creating orders for Avinash
        ...
        // Displaying Avinash's orders
        customer1.displayOrders();

        // Displaying Binod orders
