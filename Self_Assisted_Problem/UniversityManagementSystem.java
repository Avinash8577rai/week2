...
public class UniversityManagementSystem {
    public static void main(String[] args) {
        // Create professors
        Professor professor1 = new Professor("Dr. Rajesh Bogehy");
        Professor professor2 = new Professor("Dr. Nishchal Koushal");

        // Create students
        Student student1 = new Student("Avinash");
        Student student2 = new Student("Binod");
        Student student3 = new Student("Ranouak");
