...
public class HospitalDoctorsAndPatients{
    public static void main(String[] args) {
        ...
        Hospital hospital = new Hospital("City Health Center Hospital");

        // Create Doctor objects
        Doctor doctor1 = new Doctor("Anand");
        Doctor doctor2 = new Doctor("Ankit Patel");

        // Create Patient objects
        Patient patient1 = new Patient("Avinash");
        Patient patient2 = new Patient("Aakriti");
        Patient patient3 = new Patient("Ankit");
